...
import SequenceEditorSequence from '../SequenceEditorSequence/SequenceEditorSequence';
...
import SequenceEditorSelectTable from '../SequenceEditorSelectTable/SequenceEditorSelectTable';
import SequenceEditorWindowControls from '../SequenceEditorWindowControls/SequenceEditorWindowControls';
import SequenceEditorSubmitButton from '../SequenceEditorSubmitButton/SequenceEditorSubmitButton';
import SequenceEditorConfirmDeleteSequenceDialog from '../SequenceEditorConfirmDeleteSequenceDialog/SequenceEditorConfirmDeleteSequenceDialog';
...
function SequenceEditor() {
  ...
  const fetchOEIS = async (oeisId: string): Promise<void> => {
  ...
  return (
    <FlexColumnWrapper>
      ...
      {selectedOption === 'add' && customSequenceContent}
